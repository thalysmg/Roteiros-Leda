...
public class StudentBSTTest {
	...
	public void testSort(){
		...
		Integer[] array = {-5,7,3,9,-6,2,3,7,8,43,6};
		Integer[] arrayOrdenado = {-6,-5,2,3,3,6,7,7,8,9,43};
	...
	public void testReverseOrder(){
		...
		fillTree();
		Integer[] arrayOrdenado = {232,76,67,23,12,9,6,5,2,0,-34,-40};
		assertEquals(Arrays.toString(((SortComparatorBSTImpl<Integer>) tree).reverseOrder()), Arrays.toString(arrayOrdenado));
